...
const Table = () => {
  ...
  const { tellers, teller, loading, tellerByDistId } = useSelector(
    (state) => state.tellers
  );
  ...
  useEffect(() => {
    dispatch(getTelByDistId(memberLink));
  }, [dispatch, memberLink]);
  ...
  return (
    <div className="max-w-full mx-auto">
      ...
      <div className="flex flex-col shadow-md rounded-md bg-white mx-10">
        {loading ? (
              ...
              <div className="overflow-y-auto h-96">
                <div className="table-container max-h-[500px] ">
                  <table className="min-w-full text-left text-xs font-light border bg-white">
                    ...
                    <tbody>
                      {tellerByDistId.map((distributor, index) => (
                              ...
                              content={
                                <div className="space-x-2">
                                  ...
                                  <label className="cursor-pointer px-3 hover:text-green-400">
                                    <NavLink
                                      to={`/dashboard/${distributor?.distributor_id}/${distributor}`}
                                    >
                                      More
                                    </NavLink>
                                  </label>
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                onChange={(e) => handleOnChange("created_by", e.target.value)}
                required
                className="block w-full rounded-md border-0 px-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
